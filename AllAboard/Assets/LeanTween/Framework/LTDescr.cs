...
public class LTDescr
{
	...
	public Vector3 from { get => this.fromInternal; set => this.fromInternal = value; }
	internal Vector3 toInternal;
	public Vector3 to { get => this.toInternal; set => this.toInternal = value; }
	...
	public LTDescr setRotateAround()
	{
		...
		this.easeInternal = () =>
		{
			...
			Vector3 rotateAroundPt = trans.TransformPoint(this._optional.point);
			...
			rotateAroundPt = trans.TransformPoint(this._optional.point);
	...
	public LTDescr setRotateAroundLocal()
	{
		...
		this.easeInternal = () =>
		{
			...
			val = newVect.x;
			Vector3 origPos = trans.localPosition;
			trans.RotateAround(trans.TransformPoint(this._optional.point), trans.TransformDirection(this._optional.axis), -this._optional.lastVal);
			Vector3 diff = origPos - trans.localPosition;
	...
	public LTDescr setCanvasRotateAround()
	{
		...
		this.easeInternal = () =>
		{
			...
			rect.RotateAround(rect.TransformPoint(this._optional.point), this._optional.axis, -val);
	...
	public LTDescr setCanvasRotateAroundLocal()
	{
		...
		this.easeInternal = () =>
		{
			...
			RectTransform rect = this.rectTransform;
			Vector3 origPos = rect.localPosition;
			rect.RotateAround(rect.TransformPoint(this._optional.point), rect.TransformDirection(this._optional.axis), -val);
			Vector3 diff = origPos - rect.localPosition;
	...
	*/
	...
	private Vector3 easeInOutExpo()
	{
		...
		if (val < 1)
		{
			return this.diffDiv2 * Mathf.Pow(2, 10 * (val - 1)) + this.from;
		}
